  ...
  function executarBusca(alunoFixo) {
    ...
    setTimeout(() => {
      ...
      if (found) {
        ...
        setErro(
          "Nenhum discente encontrado com esse nome ou matrícula. Verifique os dados informados.",
        );
        setResultado(null);
      }
    }, 700);
        ...
        <div style={s.card}>
          ...
          <div style={s.cardBody}>
            <p style={{ fontSize: "13px", color: COLORS.muted, marginTop: 0 }}>
              Informe o nome completo ou número de matrícula do discente. Os
              resultados exibem as turmas abertas no período selecionado.
            </p>
                  ...
                  <div style={s.suggest}>
                    {sugestoes.map((a) => (
                      <div
                        ...
                        onMouseEnter={(e) =>
                          (e.target.style.background = "#f0f4f9")
                        }
                        onMouseLeave={(e) =>
            ...
            <div style={{ display: "flex", gap: "8px", marginTop: "16px" }}>
              ...
              <button style={s.btnSecondary} onClick={limpar}>
                Limpar
              </button>
            </div>
          </div>
                    ...
                    {turmas.map((t) => {
                      ...
                      return (
                        <tr key={t.id}>
                          ...
                          <td style={s.td}>
                            <code style={{ fontSize: "12px" }}>{t.id}</code>{" "}
                            {t.nome}
                          </td>
